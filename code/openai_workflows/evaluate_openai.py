...
(adapted from evaluate_baseline_check.ipynb)
"""
...
def generate_openai_predictions(
    ...
    Args:
        ...
        task_instruction (str): Task-level instruction (kept for compatibility).
        cfg (dict): Configuration dictionary (required).
    ...
    Returns:
        list[str]: Generated recipe responses.
    """
